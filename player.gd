...
@export var head_pos_standing : Vector3 = Vector3(0, 1.8, 0)
@export var head_pos_sliding : Vector3 = Vector3(0, 0.8, 0)
...
func update_ammo_label(reloading : bool):
	if reloading:
		...
		ammo_label.text = "Ammo: " + str(active_weapon.clip_ammo) + " / " + str(active_weapon.reserve_ammo)
